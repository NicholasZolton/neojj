...
describe("remote.parse", function()
  it("parses an scp-style ssh remote", function()
    ...
    assert.are.same(
      { host = "github.com", browser_url = "https://github.com/User/repo", slug = "User/repo" },
      info
    )
  end)
  ...
  it("parses an https remote without .git suffix", function()
    ...
    assert.are.same(
      { host = "gitlab.com", browser_url = "https://gitlab.com/group/project", slug = "group/project" },
      info
    )
  end)
  ...
  it("parses a self-hosted ssh remote", function()
    ...
    assert.are.same(
      { host = "git.corp.com", browser_url = "https://git.corp.com/team/repo", slug = "team/repo" },
      info
    )
  end)
