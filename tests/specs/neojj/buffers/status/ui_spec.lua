...
describe("status reference highlights", function()
  it("de-emphasizes ordinary references while preserving bookmark state colors", function()
    ...
    assert.are.equal("NeojjObjectId", highlight_for_text(layout[1], "rent1"))
    ...
    assert.are.equal("NeojjObjectId", highlight_for_text(layout[1], "entid"))
    ...
    assert.are.equal("NeojjObjectId", highlight_for_text(layout[1], "erge1"))
    ...
    assert.are.equal("NeojjObjectId", highlight_for_text(layout[1], "al-id"))
